package com.atpex.archer.spring.autoconfigure.annotation;

import com.atpex.archer.constants.Serialization;
import com.atpex.archer.spring.autoconfigure.ActiveModeConfigSelector;
import com.atpex.archer.spring.autoconfigure.ConfigSelector;
...
public @interface EnableArcher {
     ...
     *
     * @see com.atpex.archer.components.api.ValueSerializer
     */
